...
patterns = [
    ...
    (
        ...
        [
            ...
            "Sure! Here are the movies currently playing: "
            + ", ".join(movies.keys())
            + ".",
        ],
    ),
    (
        ...
        [
            ...
            "Sure! How many tickets would you like to book?",
    ...
    (
        r"(.*) showtime",
        [
            "Here are the showtimes for the available movies:"
            + f"{movie}: {', '.join(timings)}"
    ...
    (
        r"(.*) timing",
        [
            "Here are the timings for the each movie:"
            + f"{movie}: {', '.join(timings)}"
            for movie, timings in movies.items()
        ],
    ),
    ...
    (r"(.*) book tickets", ["Sure! Let's proceed with booking tickets."]),
    (
        r"(.*) (bye|goodbye)",
        [
            "Thank you for visiting ChatBot. Have a great day!",
